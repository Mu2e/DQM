...
class DqmTime {
 public:
  ...
  DqmTime(const std::string& runRange, const std::string& startTime,
  ...
  std::string csv() const {
    return std::to_string(_startRun) + "," + std::to_string(_startSubrun) +
           "," + std::to_string(_endRun) + "," + std::to_string(_endSubrun) +
           "," + _startTime + "," + _endTime;
  }
